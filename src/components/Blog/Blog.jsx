    ...
    <div className="mx-48">
      ...
      <div className="mt-10 ps-10">
        ...
        <p className="text-[gray]">
          {" "}
          when some data needs to be accessible by many components at different
          nesting levels. Apply it sparingly because it makes component reuse
          more difficult. If we only want to avoid passing some props through
        ...
        <h1 className="font-bold mt-8 text-[#6e79f2]">Q:3-What is useRef?</h1>
        <p className="text-[gray]">
          {" "}
        ...
        <h1 className="font-bold mt-8 text-[#6e79f2]">Q:4-What is useMemo?</h1>
        <p className="text-[gray]">
          {" "}
